...
from src.dope.inference.cuboid_pnp_solver import *
...
class DOPEInference():
    ...
    def __init__(self, options):
        ...
        config_path = os.path.join('./config', 'config_pose.yaml')
        self.params = None
        ...
        self.model = ModelData(self.object_info['name'], os.path.join('./weights/', self.object_info['weight'] + '.pth'))
